...
public class AZSideBarView extends View {
	...
	private void initAttribute(AttributeSet attrs, int defStyleAttr) {
		...
		mTextColor = typeArray.getColor(R.styleable.AZSideBarView_textColor, Color.parseColor("#999999"));
		...
		mSelectTextColor = typeArray.getColor(R.styleable.AZSideBarView_selectTextColor, Color.parseColor("#ff40c2fe"));
