package a.miracle.lib_zxing.camera;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = DisplayUtils.dp2px(250);
	private static final int MIN_FRAME_HEIGHT = DisplayUtils.dp2px(250);
	private static final int MAX_FRAME_WIDTH = DisplayUtils.dp2px(250);
	private static final int MAX_FRAME_HEIGHT = DisplayUtils.dp2px(250);
	...
	public void openDriver(SurfaceHolder holder) throws IOException {
		if (camera == null) {
			...
			if (!initialized) {
				...
				configManager.initScreenSize(rect.right- rect.left, rect.bottom - rect.top);
