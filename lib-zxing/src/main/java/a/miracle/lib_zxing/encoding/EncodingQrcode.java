package a.miracle.lib_zxing.encoding;
...
public class EncodingQrcode {
	 ...
	 * @param file 用于存储二维码图片的文件路径
	 * @return 生成二维码及保存文件是否成功
	 * @throws WriterException
	 */
	public static boolean createQRImage(String content, int widthAndHeight, File file){
		return createQRImage(content, widthAndHeight, widthAndHeight, null, file);
	}
